export type StoryLevel = 'easy' | 'standard';
export type StoryPack = 'core' | 'animals' | 'daily';
...
export const STORY_LEVEL_OPTIONS: Array<{
  id: StoryLevel;
  label: string;
}> = [
...
export const STORY_PACK_OPTIONS: Array<{
  id: StoryPack;
  label: string;
}> = [
...
export const STORIES_BY_LEVEL_AND_PACK: Record<StoryLevel, Record<StoryPack, StoryItem[]>> = {
  easy: {
    core: [
      {
        id: 'ilk-cumleler-1',
