...
const POFI_ASSETS = {
  normal: '/assets/pofi_emoji/pofi-emoji/pofi_emotion_neutral.png',
  sleep: '/assets/pofi_emoji/pofi-emoji/pofi_sleeping.png'
} as const;
...
export class MascotGuide {
  ...
  setSleepMode(enabled: boolean): void {
    ...
    if (this.imageEl) {
      this.imageEl.src = enabled ? POFI_ASSETS.sleep : POFI_ASSETS.normal;
    }
