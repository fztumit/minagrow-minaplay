...
export class MirrorModeModule {
    ...
    constructor(rootEl) {
        ...
        const progressFillEl = rootEl.querySelector('#mirror-progress-fill');
        const rewardEl = rootEl.querySelector('#mirror-reward');
        const rewardTextEl = rootEl.querySelector('#mirror-reward-text');
        const nextBtn = rootEl.querySelector('#mirror-next-btn');
        if (!videoEl ||
            !placeholderEl ||
            !demoEl ||
            !labelEl ||
    ...
    stopCamera() {
        this.videoEl.pause();
        const currentStream = this.videoEl.srcObject;
    ...
    triggerReward() {
        ...
        this.rootEl.dispatchEvent(new CustomEvent('mirror-activity', {
    ...
    playTone(context, gain, start, frequency, duration) {
