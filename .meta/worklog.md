...
- 2026-04-18 | Uygulama | MinaPlay temiz PWA çekirdeğinin taşınması | `/Users/umitaydin/Documents/Konusu-Yorum` referansındaki PWA çekirdeği `/Users/umitaydin/Documents/MinaGrow/MinaPlay` içine CRM/Zoho/webhook, lowdb, segmentation, eski ham assetler ve üretilebilir çıktılar dışarıda bırakılarak taşındı | Codex ve Ümit için yeni çalışma alanı daha sade, PWA odaklı ve MinaPlay/Pofi kanonuna uygun hale geldi
